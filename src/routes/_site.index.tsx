...
export const Route = createFileRoute("/_site/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Descubra como a Inteligência Artificial transforma o desenvolvimento web: carreira, tecnologias, tendências e contribuição para o ODS 9." },
    ...
    <>
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-6 py-20 md:grid-cols-2 md:py-28">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link
                to="/profissao"
                className="rounded-lg bg-[var(--gradient-hero)] px-6 py-3 font-medium text-primary-foreground transition-transform hover:scale-[1.02] glow"
              >
                Conheça a profissão
              </Link>
              <Link
                to="/tendencias"
                className="rounded-lg border border-border bg-secondary/50 px-6 py-3 font-medium text-foreground transition-colors hover:bg-secondary"
              >
                Ver tendências
              </Link>
            </div>
          ...
          <div className="relative">
            ...
            <img
              src={heroImg}
              alt="Visualização abstrata de inteligência artificial conectada ao desenvolvimento web"
              width={1600}
              height={1000}
      ...
      <section className="mx-auto max-w-5xl px-6 py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-muted-foreground">
          A Inteligência Artificial aplicada ao Desenvolvimento Web é uma das
          áreas que mais cresce na computação. Ela combina algoritmos
          inteligentes, aprendizado de máquina, automação e análise de dados
          para criar aplicações mais rápidas, eficientes, personalizadas e
          seguras. Com a transformação digital, empresas de todos os setores
          adotaram IA para melhorar a experiência do usuário, automatizar
          processos e aumentar a produtividade — de assistentes virtuais a
          recomendações personalizadas, chatbots, segurança e muito mais.
        </p>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-20">
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          {pillars.map((p, i) => (
            <article
              key={p.title}
              className="group relative overflow-hidden rounded-2xl border border-border bg-card p-6 transition-all hover:-translate-y-1 hover:border-primary/50"
            >
        ...
        <div className="relative overflow-hidden rounded-3xl border border-border bg-card p-10 md:p-16">
          ...
          <div className="relative">
            <h2 className="max-w-2xl text-3xl font-bold md:text-4xl">
              Quer entender como essa carreira contribui para um mundo mais
              sustentável?
            </h2>
            ...
            <Link
              to="/ods"
              className="mt-8 inline-block rounded-lg bg-[var(--gradient-hero)] px-6 py-3 font-medium text-primary-foreground glow"
            >
