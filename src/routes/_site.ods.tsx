...
export const Route = createFileRoute("/_site/ods")({
  head: () => ({
    meta: [
...
const contributions = [
  {
    ...
    desc: "Sistemas inteligentes tornam empresas mais produtivas e eficientes.",
    ex: "Chatbots automatizam atendimento ao cliente 24 horas por dia.",
  },
  {
    title: "Inclusão digital",
    desc: "Aplicações inteligentes facilitam o acesso à informação e a serviços.",
    ex: "Sites com IA fazem leitura automática para pessoas com deficiência visual.",
  },
  {
    title: "Segurança tecnológica",
    desc: "A IA ajuda a detectar fraudes e ataques cibernéticos.",
    ex: "Bancos identificam transações suspeitas em tempo real.",
  },
  {
    title: "Desenvolvimento econômico",
    desc: "A inovação digital gera empregos e fortalece empresas tecnológicas.",
    ex: "Startups de IA movimentam toda a economia digital brasileira.",
  },
  {
    title: "Infraestrutura inteligente",
    desc: "A IA melhora sistemas urbanos e industriais.",
    ex: "Cidades inteligentes usam IA para controle de trânsito e monitoramento.",
  },
];
  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-20">
      <div className="flex flex-wrap items-center gap-4">
        <span className="grid h-14 w-14 place-items-center rounded-2xl bg-[#FD6925] font-display text-2xl font-bold text-white">
          9
        </span>
        <div>
      ...
      <p className="mt-8 max-w-3xl text-lg text-muted-foreground">
        ...
        desenvolvimento web contribui diretamente para esses objetivos ao
        modernizar processos, democratizar o acesso digital e fortalecer a
      ...
      <section className="mt-16 space-y-5">
        {contributions.map((c, i) => (
          <article
            key={c.title}
            className="grid gap-6 rounded-2xl border border-border bg-card p-6 md:grid-cols-[auto_1fr] md:p-8"
          >
            <div className="grid h-12 w-12 place-items-center rounded-xl bg-[var(--gradient-hero)] font-display text-lg font-bold text-primary-foreground">
              {i + 1}
            </div>
            <div>
