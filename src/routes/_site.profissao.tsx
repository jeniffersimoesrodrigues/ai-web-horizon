...
export const Route = createFileRoute("/_site/profissao")({
  head: () => ({
    meta: [
      { title: "Sobre a Profissão — IA & Dev Web" },
      { name: "description", content: "O que faz um profissional de Inteligência Artificial aplicada ao Desenvolvimento Web: atividades, tecnologias, salários e formação." },
    ...
    <div className="mx-auto max-w-6xl px-6 py-20">
      ...
      <section className="mt-16 rounded-2xl border border-border bg-card p-8">
        ...
        <p className="mt-4 text-muted-foreground">
          ...
          atendimento; sites personalizam anúncios e conteúdo. A IA já está em
          praticamente todas as experiências digitais que usamos.
        </p>
      </section>
